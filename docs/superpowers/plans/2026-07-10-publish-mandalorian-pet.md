...
PRIVATE_USERS_ROOT='/Users'
PRIVATE_USERS_PATTERN="${PRIVATE_USERS_ROOT}/[^/[:space:]]+"
BLIND_KEY_PREFIX='direction-blind-answer-'
BLIND_KEY_SUFFIX='key'
PROMPTS_DIR='prompts'
! rg -n "${PRIVATE_USERS_PATTERN}|${BLIND_KEY_PREFIX}${BLIND_KEY_SUFFIX}|${PROMPTS_DIR}/" README.md pet.json SHA256SUMS LICENSE* qa scripts docs/superpowers/specs docs/superpowers/plans
```
